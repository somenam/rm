            ...
            <div id="mainmenu">
                ...
                $this->widget('zii.widgets.CMenu', array(
                    'items' => array(
                        ...
                        array('label' => 'Загрузить', 'url' => array('/reboot/download'), 'visible' => !Yii::app()->user->isGuest),
                        //array('label' => 'Contact', 'url' => array('/site/contact')),
                        array('label' => 'Ребуты', 'url' => array('/reboot/list'), 'visible' => !Yii::app()->user->isGuest),
                        array('label' => 'Профиль', 'url' => array('/user/update'), 'visible' => !Yii::app()->user->isGuest),
